    ...
    internal class SkillStorage
    {
        ...
        public static void Create()
        {
            Table = new Dictionary<string, Skill>()
            {
                ...
                { R.Warrior_アークスタンプ.SHA1Hash(), Skill.Create(nameof(R.Warrior_アークスタンプ), "スタンプ", 36) },
                { R.Warrior_アークスタンプ_S.SHA1Hash(), Skill.Create(nameof(R.Warrior_アークスタンプ_S), "スタンプ", 36) },
                ...
                { R.Warrior_ソリッドウォール.SHA1Hash(), Skill.Create(nameof(R.Warrior_ソリッドウォール), "ソリッド", 50) },
                { R.Warrior_ソリッドウォール_S.SHA1Hash(), Skill.Create(nameof(R.Warrior_ソリッドウォール_S), "ソリッド", 50) },
